...
-->
``` http
PATCH /users/{usersId}/authentication/microsoftAuthenticatorMethods
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/authentication/microsoftAuthenticatorMethods
...
{
  "@odata.type": "#microsoft.graph.microsoftAuthenticatorAuthenticationMethod",
  "id": "bb956ee5-6ee5-bb95-e56e-95bbe56e95bb"
}
```
