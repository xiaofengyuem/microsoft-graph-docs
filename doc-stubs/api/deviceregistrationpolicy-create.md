...
description: "Create a new deviceRegistrationPolicy object."
...
Create a new [deviceRegistrationPolicy](../resources/deviceregistrationpolicy.md) object.
...
-->
``` http
POST ** Collection URI for microsoft.deviceRegistrationPolicy.deviceRegistrationPolicy not found
```
...
If successful, this method returns a `201 Created` response code and a [deviceRegistrationPolicy](../resources/deviceregistrationpolicy.md) object in the response body.
...
<!-- {
  "blockType": "request",
  "name": "create_deviceregistrationpolicy_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.deviceRegistrationPolicy.deviceRegistrationPolicy not found
