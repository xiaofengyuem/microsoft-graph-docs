...
|:---|:---|:---|
|allowedGroups|String collection|**TODO: Add Description**|
|allowedUsers|String collection|**TODO: Add Description**|
|appliesTo|policyScope|**TODO: Add Description**. Possible values are: `none`, `all`, `selected`, `unknownFutureValue`.|
|isAdminConfigurable|Boolean|**TODO: Add Description**|
