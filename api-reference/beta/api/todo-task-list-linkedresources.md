...
If successful, this method returns a `200 OK` response code and a collection of [linkedResource](../resources/todo-linkedresource.md) objects in the response body.
