...
Read the properties and relationships of a [linkedResource](../resources/todo-linkedresource.md) object.
...
If successful, this method returns a `200 OK` response code and a [linkedResource](../resources/todo-linkedresource.md) object in the response body.
