...
Update the properties of a [task](../resources/todo-task.md) object.
...
If successful, this method returns a `200 OK` response code and an updated [task](../resources/todo-task.md) object in the response body.
