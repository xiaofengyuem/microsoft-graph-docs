...
| [task](../resources/todo-task.md) | Tasks.ReadWrite | Tasks.ReadWrite | Tasks.ReadWrite.All |
| [tasklist](../resources/todo-tasklist.md)  | Tasks.ReadWrite | Tasks.ReadWrite | Tasks.ReadWrite.All |
...
GET /users/{Id|userPrincipalName}/todo/lists/{taskListId}/tasks/{taskId}/extensions/{extensionId}
GET /users/{Id|userPrincipalName}/todo/lists/{taskListId}/extensions/{extensionId}
```
...
GET /users/{Id|userPrincipalName}/todo/lists/{taskListId}/tasks/{Id}?$expand=extensions($filter=id eq '{extensionId}')
