...
An entity of type `chatMessageAttachment` is returned as part of the [Get messages](../api/chatmessage-list.md) API, as a part of [chatMessage](chatmessage.md) entity.
