...
|[chatMessage](../resources/chatmessage.md)| [list in channel](../api/chatmessage-list.md), [list in chat](../api/chatmessage-list.md), [send](../api/chatmessage-post.md), [read in channel](../api/chatmessage-get.md), [read in chat](../api/chatmessage-get.md)|
