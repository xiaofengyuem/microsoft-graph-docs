...
An entity of type `chatMessageReaction` is returned as part of the [Get message](../api/chatmessage-get.md) API, as a part of the [chatMessage](chatmessage.md) entity.
