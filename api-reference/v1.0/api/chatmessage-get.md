...
# Get Get message in a channel or a chat

Namespace: microsoft.graph

Retrieve a single [message](../resources/chatmessage.md) (without its replies) in a [channel](../resources/channel.md) or a [chat](../resources/chat.md). 
...
- [List messages in a channel or a chat](chatmessage-list.md)
