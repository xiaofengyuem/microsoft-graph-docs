...
In the following examples, the URL can use the [HTTP syntax](#http-request) described to send a message to a chat, send a message to a channel reply to a message in a channel.
...

{
    ...
    "body": {
        "contentType": "html",
        "content": "<div><div>\n<div><span><img height=\"297\" src=\"https://graph.microsoft.com/v1.0/teams/233ae542-57e7-4593-b5bf-50549df74710/channels/19:8af03d1e70f5455fbb74d36acbe2957f@thread.$value\" width=\"297\" style=\"vertical-align:bottom; width:297px; height:297px\"></span>\n\n</div>\n\n\n</div>\n</div>"
    },
    "channelIdentity": {
